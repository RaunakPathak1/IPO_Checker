...
eval_questions = [
    ...
    {"Raw Material Source Reliability": "How reliable are the company's raw material sources, and are there potential trade disruptions due to sourcing from sensitive locations?"},

    {"Management Future Plans": "What are the company management's clearly stated future plans and strategies?"},

    {"GDP Growth Rate (Annual)": "What is the current GDP growth rate and how does it compare with other relevant economies?"},

    {"Labor Cost": "What is the comparative labor cost for the regions in which the company operates?"},
    ...
    {"Customer Concentration": "What is the level of customer concentration, and do a small number of clients contribute disproportionately to revenue?"}
]
